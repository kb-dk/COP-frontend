      ...
      <section id="metaData">
		...
		<xsl:value-of select="format-number($sizeInBytes div 1048576,'#.##')"/>mb.
            ...
            <xsl:element name="dd">
              ...
              <xsl:value-of
                      select="md:mods/md:extension/mix:mix/mix:BasicImageInformation/mix:BasicImageCharacteristics/mix:imageWidth"/>
              x
              <xsl:value-of
                      select="md:mods/md:extension/mix:mix/mix:BasicImageInformation/mix:BasicImageCharacteristics/mix:imageHeight"/>
              (pixels)
            </xsl:element>
          </xsl:if>
