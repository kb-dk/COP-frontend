...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="isoplaces" select="document('../../common_xslt/iso3166.xml')"/>
    ...
    <xsl:template name="mods_renderer">
        ...
        <xsl:if test="md:mods/md:physicalDescription/md:form[@type='technique']">
            <xsl:element name="li">
                <xsl:if test="position() = 1">
                    <strong xml:lang="en">Resource type:</strong>
                    <strong xml:lang="da">Ressourcetype:</strong>
                </xsl:if>
                <xsl:value-of select="md:mods/md:physicalDescription/md:form[@type='technique']"/>
            </xsl:element>
        </xsl:if>
        ...
        <xsl:if test="md:mods/md:extension/mix:mix/node()">
            <xsl:variable name="sizeInBytes" select="md:mods/md:extension/mix:mix/mix:BasicDigitalObjectInformation/mix:fileSize"/>
            <li>
                ...
                <xsl:element name="span">
                    ...
                    <xsl:value-of select="md:mods/md:extension/mix:mix/mix:BasicImageInformation/mix:BasicImageCharacteristics/mix:imageWidth" /> x
                    <xsl:value-of select="md:mods/md:extension/mix:mix/mix:BasicImageInformation/mix:BasicImageCharacteristics/mix:imageHeight" /> (pixels)
                </xsl:element>
