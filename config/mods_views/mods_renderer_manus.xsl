...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xalan:component prefix="string" functions="replaceAll">
    <xalan:script lang="javaclass" src="xalan://java.lang.String"/>
  </xalan:component>
	...
	<xsl:element name="div">
	  ...
	  <section id="imgPreview">
		...
		<!-- 
		     ...
		     <xsl:choose>
		     TODO vælg imellem billed og Paging på en anden måde
