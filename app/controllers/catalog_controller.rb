  ...
  configure_blacklight do |config|
    ...
    config.add_search_field 'all_fields', label: 'All Fields' do |field|
      ...
      field.solr_local_parameters = {
          :qf => 'cobject_title_ssi^100 full_title_tsim^90 creator_tsim^80 description_tsim^50 pub_dat_tsim^40 readable_dat_string_tsim^40 type_tdsim^30 dc_type_ssim^30 subject_tdsim^30 coverage_tdsim^30 local_id_ssi^30 shelf_mark_tdsim^20 subject_topic_facet_tdsim^20 subject_topic_facet_tesim^20'
      }
    end
